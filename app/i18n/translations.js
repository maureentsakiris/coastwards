	module.exports = {
		...
		"upload_error": {
			"en": "Ohno, something went wrong during upload. I'm sure this is my fault (or maybe your connection is bad). Try again?",
		...
		"accept_terms": {
			...
			"hi": "{terms} को पढ़ और स्वीकार कर लिया है" //Amit
		},
		"terms": {
			"en": "Terms",
			"de": "Bedingungen",
		...
		"save_image": {
			...
			"hi": "हम छवि को पिक्सेल की चौड़ाई में {imageWidth} सहेजते हैं और मेटाडाटा को अलग करते हैं" //Amit
		},
		"uid": {
		...
		"share_text_intro": {
			...
			"hi": "साझा करने के कई तरीके हैं बेशक, {facebook} और ट्विटर हैं {twitter} आप अगली पीढ़ी हैं तो आप {whatsapp} या किसी अन्य प्रोग्राम को पसंद कर सकते हैं मुझे इसके बारे में पता नहीं है क्योंकि मैं बहुत बूढ़ा हूं या अापके देश में उपयोग किए जाने वाले प्लेटफार्मों से परिचित नहीं हूं।" //Amit
		},
		"share_text_but": {
		...
		"terms_cc0": {
			...
			"hi": "इस छवि को अपलोड करके आप अपने कॉपीराइट को छोड़ने और सार्वजनिक डोमेन में छवि को स्थान देने के लिए सहमत हैं। ({license})" //Amit
		},
		"license": {
