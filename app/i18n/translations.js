module.exports = {
	...
	"error_parsing_geojson": {
		"en": "Crap, the pictures are not loading. Try refreshing the page!",
	...
	"error_loading_mapbox": {
		"en": "Crap, the map is not loading. Try refreshing the page!",
	...
	"upload_error": {
		"en": "Crap, something went wrong during upload. I'm sure this is my fault (or maybe your connection is bad). Try again?",
	...
	"hashtag": {
		"en": "Sign your image with a hashtag! (Search by hashtag is planned)",
		"de": "Gib deinem Foto ein Hashtag (Eine Suchfunktion ist geplant)",
		"es": "Firma tu foto con un hashtag (Una búsqueda por hashtag está planificado)"
	},
	"hashtag_placeholder": {
		"en": "#iwashere",
		"de": "#ichwarhier",
	...
	"whyIP_text": {
		"en": "We need to be able to prove that we are not the source of the image. Basically, we are covering our own asses BUT we can only point to your IP Address, not to you.",
	...
	"zoom_closer": {
		"en": "You gotta zoom until the marker turns green!",
