...
const messages = defineMessages( {
	...
	share_header:{
		id: "share_header",
		description: "Header",
		defaultMessage: "Share with friends and family (especially if they live near the coast!)"
	},
	share_text_intro:{
		id: "share_text_intro",
		description: "P - ",
	...
	share_go_coastwards:{
		id: "share_go_coastwards",
		description: "P",
		defaultMessage: "Go coastwards!"
	}
		...
		<DIV className={ className } >
			...
			<P><FormattedMessage
					...
					values={ {
						...
						whatsapp: <A className={ style.link } href="whatsapp://send?text=Hello%20World!">WHATSAPP</A>
			...
			<BR/>
			<H priority={ 2 }>{ formatMessage( messages.share_go_coastwards ) }</H>
		</DIV>
