...
import style from './_styleFeature';
...
class Feature extends Component {
	...
	render () {
		...
		const { feature, ...restProps } = this.props; // eslint-disable-line no-unused-vars
		
		const cls = Classnames( style.dialog );

		const content = this._renderFeature( feature );

		return (

			<div ref="featureDOM" { ...restProps } className={ cls } >
				{ content }
			</div>
